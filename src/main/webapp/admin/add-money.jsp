      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link " href="">
            ...
            <span class="nav-link-text ms-1">Print Requests</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="">
            ...
            <span class="nav-link-text ms-1">Token Print</span>
          </a>
        </li>
        ...
        <li class="nav-item">
            <a class="nav-link " href="">
              ...
              <span class="nav-link-text ms-1">Manage Pricing</span>
            </a>
          </li>
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-white active" aria-current="page">Add Money</li>
          </ol>
          <h6 class="font-weight-bolder text-white mb-0">Add Money</h6>
        </nav>
