            ...
            <div class="card-body">
              <form role="form">
                ...
                <div class="form-group">
                  <input class="form-control" type="tel" aria-label="Phone" placeholder="Phone" id="example-tel-input">
              </div>
                <div class="mb-3">
                  <input type="password" class="form-control" placeholder="Password" aria-label="Password">
                </div>
                <div class="mb-3">
                  <select class="form-control " aria-label="Select Degree">
                    <option>Select Degree</option>
                    <option>B.Tech</option>
                    <option>Ploytechnic</option>
                    <option>MCA</option>
                ...
                <div class="mb-3">
                  <select class="form-control " aria-label="Select Branch">
