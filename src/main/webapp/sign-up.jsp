    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navigation">
        <ul class="navbar-nav mx-auto">
          ...
          <li class="nav-item">
            <a class="nav-link me-2" href="login.jsp">
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-5 text-center mx-auto">
            <h1 class="text-white mb-2 mt-5">Welcome to ePrint Software!</h1>
          </div>
        </div>
      </div>
    </div>
    <div class="container">
      <div class="row mt-lg-n10 mt-md-n1 mt-n10 justify-content-center">
            ...
            <div class="card-body">
              <form role="form" action="RegistrationController" method="post" >
                ...
                <div class="form-group">
                  <input class="form-control" name="phone" type="tel" aria-label="Phone" placeholder="Phone" id="example-tel-input">
              </div>
                <div class="mb-3">
                  <input type="password" name="password" class="form-control" placeholder="Password" aria-label="Password">
                </div>
                <div class="mb-3">
                  <select class="form-control " name="degree" aria-label="Select Degree">
                ...
                <div class="mb-3">
                  <select class="form-control " name="branch" aria-label="Select Branch">
