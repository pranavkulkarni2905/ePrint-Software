    ...
    <section>
      <div class="page-header min-vh-100">
        <div class="container">
          ...
          <div class="row">
            <div class="col-md-12 d-flex flex-column mx-lg-0 mx-auto justify-content-center align-items-center">
              <div class="row">
              <div class="card card-plain">
                <div class="card-header pb-0 text-start">
                  <lottie-player src="https://assets8.lottiefiles.com/packages/lf20_itcrGGb0Vu.json"  background="transparent"  speed="1"  style="width: 300px; height: 300px;"  loop  autoplay></lottie-player>
