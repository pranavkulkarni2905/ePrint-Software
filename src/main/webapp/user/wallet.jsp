  ...
  <aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="">
        ...
        <span class="ms-1 font-weight-bold">Hello Pranavrav!</span>
      </a>
    </div>
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link " href="">
            ...
            <span class="nav-link-text ms-1">Send Document</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link " href="">
            ...
            <span class="nav-link-text ms-1">Print History</span>
          </a>
        </li>
        ...
        <li class="nav-item">
          <a class="nav-link " href="">
            ...
            <span class="nav-link-text ms-1">Print Options</span>
          </a>
        </li>
      ...
      <div class="card card-plain shadow-none" id="sidenavCard">
        ...
        <div class="card-body text-center p-3 w-100 pt-0">
          <div class="docs-info">
            ...
            <p class="text-xs font-weight-bold mb-0">Feel free to ask</p>
          </div>
        </div>
      </div>
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            <li class="breadcrumb-item text-sm"><a class="text-primary" href="javascript:;">Pages</a></li>
            <li class="breadcrumb-item text-sm text-primary active" aria-current="page">Wallet</li>
          </ol>
          <h6 class="font-weight-bolder text-primary mb-0">Wallet</h6>
        </nav>
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
          ...
          <ul class="navbar-nav  justify-content-end">
            ...
            <li class="nav-item px-3 d-flex align-items-center">
              <a href="javascript:;" class="nav-link text-primary p-0">
            ...
            <div class="col-md-12">
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="py-3">
                            <span class="text-uppercase font-10 weight-600 ">Percentage</span>
