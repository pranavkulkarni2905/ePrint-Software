	...
	<aside
		...
		<div class="sidenav-header">
			<i
				...
				href=""> <img src="../assets/img/logo-ct-dark.png"
				class="navbar-brand-img h-100" alt="main_logo"> <span
				class="ms-1 font-weight-bold">Hello admin!</span>
			</a>
		<hr class="horizontal dark mt-0">
		<div class="collapse navbar-collapse  w-auto "
			id="sidenav-collapse-main">
			<ul class="navbar-nav">
				<li class="nav-item"><a class="nav-link active" href="../admin/index.jsp">
						<div
							class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
							<i class="ni ni-tv-2 text-primary text-sm opacity-10"></i>
						</div> <span class="nav-link-text ms-1">Dashboard</span>
				</a></li>
				<li class="nav-item"><a class="nav-link " href="add-money.jsp">
						<div
							class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
							<i class="ni ni-send text-warning text-sm opacity-10"></i>
						</div> <span class="nav-link-text ms-1">Add Money</span>
				</a></li>
				<li class="nav-item"><a class="nav-link " href="token-print.jsp">
						<div
							class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
							<i class="ni ni-single-copy-04 text-info text-sm opacity-10"></i>
						</div> <span class="nav-link-text ms-1">Token Print</span>
				</a></li>
		...
		<div class="sidenav-footer mx-3 ">
			...
			<a href="" class="btn btn-dark btn-sm w-100 mb-3">Contact Us</a> <a
				class="btn btn-primary btn-sm mb-0 w-100" href="" type="button">Logout</a>
		</div>
	</aside>
